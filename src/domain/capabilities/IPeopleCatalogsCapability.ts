...
export interface IPeopleCatalogsCapability {
   ...
   */
  getPeopleCatalogs(category?: string): Promise<Catalog[]>
   ...
   */
  getTrendingPeople(timeWindow?: string): Promise<Catalog>
   ...
   */
  getPeopleByCriteria(criteria: Record<string, any>): Promise<Catalog>
}
